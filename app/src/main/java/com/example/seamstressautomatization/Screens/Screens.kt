...
fun Clothes(){
    Column (modifier = Modifier.fillMaxSize()){
        Text(text = "Страница одежды", modifier = Modifier.align(Alignment.CenterHorizontally))
    }
}
@Composable
fun Parts(){
    Column (modifier = Modifier.fillMaxSize()){
        Text(text = "Страница частей", modifier = Modifier.align(Alignment.CenterHorizontally))
    }
}